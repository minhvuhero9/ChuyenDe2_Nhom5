...
public class DangDepAdapter extends RecyclerView.Adapter<DangDepAdapter.ViewHolder> {
    ...
    public DangDepAdapter(Context context, ArrayList<danhMucAll> list) {
    ...
    public DangDepAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new DangDepAdapter.ViewHolder(itemView);
    }
    ...
    private DangDepAdapter.OnItemClickedListener onItemClickedListener;

    // Tạo setter cho biến interface ta vừa tạo
    public void setOnItemClickedListener(DangDepAdapter.OnItemClickedListener onItemClickedListener) {
